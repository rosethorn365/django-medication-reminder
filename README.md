...
Sovelluksessa on selkeä ja saavutettava käyttöliittymä. Teksti on isoa (20px), värit ovat hyväkontrastisia ja käyttö onnistuu myös pelkällä näppäimistöllä. Sivulla on myös “siirry sisältöön” -linkki ja selkeät virheilmoitukset, jotka auttavat käyttöä esimerkiksi ruudunlukijan kanssa. Tämä tekee sovelluksesta helppokäyttöisen ihmisille, joilla on näkö- tai motorisia haasteita.
